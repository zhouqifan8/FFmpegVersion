...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=./android/x86 --enable-shared --disable-static --disable-doc --disable-ffplay --disable-ffmpeg --disable-ffprobe --disable-symver --disable-yasm --disable-asm --cross-prefix='D:/AS/NDK/android-ndk-r15c/toolchains/x86-4.9/prebuilt/windows-x86_64/bin/i686-linux-android-' --extra-cflags=-I/d/ffmpeg/ffmpeg4.0/ffmpeg-4.0/libx264/android/x86/include --extra-ldflags=-L/d/ffmpeg/ffmpeg4.0/ffmpeg-4.0/libx264/android/x86/lib --target-os=android --arch=x86 --enable-cross-compile --sysroot='D:/AS/NDK/android-ndk-r15c/platforms/android-14/arch-x86' --enable-libx264 --enable-encoder=libx264 --enable-small --enable-gpl --enable-pic --enable-jni --enable-mediacodec --enable-decoder=h264_mediacodec --enable-hwaccel=h264_mediacodec --enable-decoder=hevc_mediacodec --enable-decoder=mpeg4_mediacodec --enable-decoder=vp8_mediacodec --enable-decoder=vp9_mediacodec --enable-nonfree --enable-version3 --extra-cflags='-O3 -DANDROID -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums -fno-strict-aliasing -fomit-frame-pointer -march=k8   -O3 -Wall -pipe -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID  ' --extra-ldflags='  '
prefix=./android/x86
...
INTRINSICS=none
EXTERN_PREFIX=
CC=D:/AS/NDK/android-ndk-r15c/toolchains/x86-4.9/prebuilt/windows-x86_64/bin/i686-linux-android-gcc
CXX=D:/AS/NDK/android-ndk-r15c/toolchains/x86-4.9/prebuilt/windows-x86_64/bin/i686-linux-android-g++
AS=D:/AS/NDK/android-ndk-r15c/toolchains/x86-4.9/prebuilt/windows-x86_64/bin/i686-linux-android-gcc
OBJCC=D:/AS/NDK/android-ndk-r15c/toolchains/x86-4.9/prebuilt/windows-x86_64/bin/i686-linux-android-gcc
LD=D:/AS/NDK/android-ndk-r15c/toolchains/x86-4.9/prebuilt/windows-x86_64/bin/i686-linux-android-gcc
DEPCC=D:/AS/NDK/android-ndk-r15c/toolchains/x86-4.9/prebuilt/windows-x86_64/bin/i686-linux-android-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=D:/AS/NDK/android-ndk-r15c/toolchains/x86-4.9/prebuilt/windows-x86_64/bin/i686-linux-android-gcc
DEPASFLAGS= $(CPPFLAGS)
X86ASM=nasm
DEPX86ASM=nasm
DEPX86ASMFLAGS=$(X86ASMFLAGS)
AR=D:/AS/NDK/android-ndk-r15c/toolchains/x86-4.9/prebuilt/windows-x86_64/bin/i686-linux-android-ar
ARFLAGS=rcD
AR_O=$@
AR_CMD=D:/AS/NDK/android-ndk-r15c/toolchains/x86-4.9/prebuilt/windows-x86_64/bin/i686-linux-android-ar
NM_CMD=D:/AS/NDK/android-ndk-r15c/toolchains/x86-4.9/prebuilt/windows-x86_64/bin/i686-linux-android-nm -g
RANLIB=D:/AS/NDK/android-ndk-r15c/toolchains/x86-4.9/prebuilt/windows-x86_64/bin/i686-linux-android-ranlib -D
STRIP=D:/AS/NDK/android-ndk-r15c/toolchains/x86-4.9/prebuilt/windows-x86_64/bin/i686-linux-android-strip
STRIPTYPE=direct
NVCC=nvcc
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=D:/AS/NDK/android-ndk-r15c/platforms/android-14/arch-x86 -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
CFLAGS=  -I/d/ffmpeg/ffmpeg4.0/ffmpeg-4.0/libx264/android/x86/include -O3 -DANDROID -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums -fno-strict-aliasing -fomit-frame-pointer -march=k8 -O3 -Wall -pipe -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -std=c11 -fomit-frame-pointer -fPIC -pthread -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -I/d/ffmpeg/ffmpeg4.0/ffmpeg-4.0/libx264/android/x86/include -O3 -DANDROID -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums -fno-strict-aliasing -fomit-frame-pointer -march=k8 -O3 -Wall -pipe -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -fPIC -g
...
LD_PATH=-L
DLLTOOL=
WINDRES=D:/AS/NDK/android-ndk-r15c/toolchains/x86-4.9/prebuilt/windows-x86_64/bin/i686-linux-android-windres
DEPWINDRES=D:/AS/NDK/android-ndk-r15c/toolchains/x86-4.9/prebuilt/windows-x86_64/bin/i686-linux-android-gcc
DOXYGEN=doxygen
LDFLAGS= -L/d/ffmpeg/ffmpeg4.0/ffmpeg-4.0/libx264/android/x86/lib   --sysroot=D:/AS/NDK/android-ndk-r15c/platforms/android-14/arch-x86 -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDSOFLAGS=
