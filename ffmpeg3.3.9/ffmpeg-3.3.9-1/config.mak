...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/d/ffmpeg3.3.9/ffmpeg-3.3.9/android/arm --enable-shared --disable-static --disable-doc --enable-cross-compile --cross-prefix='D:/ndk15/android-ndk-r15c/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-' --target-os=linux --arch=arm --sysroot='D:/ndk15/android-ndk-r15c/platforms/android-18/arch-arm' --extra-cflags='-Os -fpic -marm' --extra-ldflags=
prefix=/d/ffmpeg3.3.9/ffmpeg-3.3.9/android/arm
...
DOXYGEN=doxygen
LDFLAGS=   --sysroot=D:/ndk15/android-ndk-r15c/platforms/android-18/arch-arm -isysroot D:/ndk15/android-ndk-r15c/platforms/android-18/arch-arm -march=armv5te -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
