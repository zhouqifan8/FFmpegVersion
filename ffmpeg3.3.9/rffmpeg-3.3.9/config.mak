...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=./android/x86 --enable-shared --disable-static --disable-doc --disable-ffplay --disable-ffmpeg --disable-ffprobe --disable-ffserver --disable-symver --disable-yasm --disable-asm --enable-pic --cross-prefix='D:/ndk15/android-ndk-r15c/toolchains/x86-4.9/prebuilt/windows-x86_64/bin/i686-linux-android-' --target-os=android --arch=x86 --enable-cross-compile --sysroot='D:/ndk15/android-ndk-r15c/platforms/android-14/arch-x86' --extra-cflags='-O3 -DANDROID -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums -fno-strict-aliasing -fomit-frame-pointer -march=k8   -O3 -Wall -pipe -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID  ' --extra-ldflags='  '
prefix=./android/x86
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=D:/ndk15/android-ndk-r15c/platforms/android-14/arch-x86 -isysroot D:/ndk15/android-ndk-r15c/platforms/android-14/arch-x86 -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
...
OBJCFLAGS=  
ASFLAGS=  -O3 -DANDROID -Dipv6mr_interface=ipv6mr_ifindex -fasm -Wno-psabi -fno-short-enums -fno-strict-aliasing -fomit-frame-pointer -march=k8 -O3 -Wall -pipe -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wno-psabi -Wa,--noexecstack -DANDROID -fPIC -g
AS_C=-c
AS_O=-o $@
OBJCC_C=-c
OBJCC_E=-E -o $@
...
DOXYGEN=doxygen
LDFLAGS=   --sysroot=D:/ndk15/android-ndk-r15c/platforms/android-14/arch-x86 -isysroot D:/ndk15/android-ndk-r15c/platforms/android-14/arch-x86 -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
