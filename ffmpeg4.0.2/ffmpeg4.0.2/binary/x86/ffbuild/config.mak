...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/d/ffmpeg/ffmpeg4.0.2/ffmpeg4.0.2/dist/ffmpeg-4.0.2/x86/ --target-os=android --arch=x86 --sysroot='D:/AS/NDK/android-ndk-r15c/platforms/android-18/arch-x86' --enable-cross-compile --cross-prefix='D:/AS/NDK/android-ndk-r15c/toolchains/x86-4.9/prebuilt/windows-x86_64/bin/i686-linux-android-' --extra-cflags='-march=i686 -mtune=intel -mssse3 -mfpmath=sse -m32 -Os -fPIC -DANDROID -Wfatal-errors -Wno-deprecated' --extra-ldflags='-LD:/AS/NDK/android-ndk-r15c/platforms/android-18/arch-x86/usr/lib' --disable-static --enable-shared --disable-yasm --disable-asm --enable-pic --disable-x86asm --enable-jni --enable-mediacodec --disable-encoders --enable-encoder=aac --enable-encoder=mjpeg --enable-encoder=png --disable-decoders --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=h264 --enable-decoder=h264_mediacodec --enable-hwaccel=h264_mediacodec --enable-decoder=mpeg4 --enable-decoder=mpeg4_mediacodec --enable-decoder=mjpeg --enable-decoder=png --disable-demuxers --enable-demuxer=image2 --enable-demuxer=h264 --enable-demuxer=aac --disable-parsers --enable-parser=aac --enable-parser=ac3 --enable-parser=h264 --enable-gpl --disable-doc --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-symver --disable-debug --enable-small
prefix=/d/ffmpeg/ffmpeg4.0.2/ffmpeg4.0.2/dist/ffmpeg-4.0.2/x86/
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=D:/AS/NDK/android-ndk-r15c/platforms/android-18/arch-x86 -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
CFLAGS=  -march=i686 -mtune=intel -mssse3 -mfpmath=sse -m32 -Os -fPIC -DANDROID -Wfatal-errors -Wno-deprecated -std=c11 -fomit-frame-pointer -fPIC -pthread -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -march=i686 -mtune=intel -mssse3 -mfpmath=sse -m32 -Os -fPIC -DANDROID -Wfatal-errors -Wno-deprecated -fPIC
...
DOXYGEN=doxygen
LDFLAGS= -LD:/AS/NDK/android-ndk-r15c/platforms/android-18/arch-x86/usr/lib  --sysroot=D:/AS/NDK/android-ndk-r15c/platforms/android-18/arch-x86 -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDSOFLAGS=
