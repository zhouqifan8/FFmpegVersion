...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --prefix=/d/ffmpeg-3.2.1/android/arm --arch=arm --disable-doc --enable-shared --disable-static --disable-yasm --disable-symver --enable-gpl --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-doc --disable-symver --cross-prefix='D:/ndk15/android-ndk-r15c/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-' --enable-cross-compile --sysroot='D:/ndk15/android-ndk-r15c/platforms/android-9/arch-arm/' --extra-cflags='-Os -fpic -marm' --extra-ldflags=-marm
prefix=/d/ffmpeg-3.2.1/android/arm
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=D:/ndk15/android-ndk-r15c/platforms/android-9/arch-arm/ -isysroot D:/ndk15/android-ndk-r15c/platforms/android-9/arch-arm/ -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
...
DOXYGEN=doxygen
LDFLAGS= -marm  --sysroot=D:/ndk15/android-ndk-r15c/platforms/android-9/arch-arm/ -isysroot D:/ndk15/android-ndk-r15c/platforms/android-9/arch-arm/ -march=armv5te -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
