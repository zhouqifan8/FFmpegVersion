...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/d/ffmpeg3.4.6/ffmpeg3.4.6/dist/ffmpeg-3.4.6/armeabi-v7a/ --target-os=android --arch=arm --sysroot='D:/ndk15/android-ndk-r15c/platforms/android-18/arch-arm' --enable-cross-compile --cross-prefix='D:/ndk15/android-ndk-r15c/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-' --extra-cflags='-march=armv7-a -mfloat-abi=softfp -mfpu=neon -Os -fPIC -DANDROID -Wfatal-errors -Wno-deprecated' --extra-ldflags='-LD:/ndk15/android-ndk-r15c/platforms/android-18/arch-arm/usr/lib' --disable-static --enable-shared --disable-yasm --disable-asm --enable-pic --disable-x86asm --enable-jni --enable-mediacodec --disable-encoders --enable-encoder=aac --enable-encoder=mjpeg --enable-encoder=png --disable-decoders --enable-decoder=aac --enable-decoder=aac_latm --enable-decoder=h264 --enable-decoder=h264_mediacodec --enable-hwaccel=h264_mediacodec --enable-decoder=mpeg4 --enable-decoder=mpeg4_mediacodec --enable-decoder=mjpeg --enable-decoder=png --disable-demuxers --enable-demuxer=image2 --enable-demuxer=h264 --enable-demuxer=aac --disable-parsers --enable-parser=aac --enable-parser=ac3 --enable-parser=h264 --enable-gpl --disable-doc --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-symver --disable-debug --enable-small
...
INSTALL_NAME_DIR=
SRC_PATH=/d/ffmpeg3.4.6/ffmpeg3.4.6/ffmpeg-3.4.6
SRC_LINK=/d/ffmpeg3.4.6/ffmpeg3.4.6/ffmpeg-3.4.6
...
ARCH=c
INTRINSICS=none
CC=D:/ndk15/android-ndk-r15c/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-gcc
CXX=D:/ndk15/android-ndk-r15c/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-g++
AS=D:/ndk15/android-ndk-r15c/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-gcc
OBJCC=D:/ndk15/android-ndk-r15c/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-gcc
LD=D:/ndk15/android-ndk-r15c/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-gcc
DEPCC=D:/ndk15/android-ndk-r15c/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=D:/ndk15/android-ndk-r15c/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-gcc
DEPASFLAGS= $(CPPFLAGS)
X86ASM=nasm
DEPX86ASM=nasm
DEPX86ASMFLAGS=$(X86ASMFLAGS)
AR=D:/ndk15/android-ndk-r15c/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-ar
ARFLAGS=rcD
AR_O=$@
RANLIB=D:/ndk15/android-ndk-r15c/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-ranlib -D
STRIP=D:/ndk15/android-ndk-r15c/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-strip
STRIPTYPE=direct
NVCC=nvcc
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=D:/ndk15/android-ndk-r15c/platforms/android-18/arch-arm -isysroot D:/ndk15/android-ndk-r15c/platforms/android-18/arch-arm -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
...
LD_PATH=-L
DLLTOOL=
WINDRES=D:/ndk15/android-ndk-r15c/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-windres
DEPWINDRES=D:/ndk15/android-ndk-r15c/toolchains/arm-linux-androideabi-4.9/prebuilt/windows-x86_64/bin/arm-linux-androideabi-gcc
DOXYGEN=doxygen
LDFLAGS= -LD:/ndk15/android-ndk-r15c/platforms/android-18/arch-arm/usr/lib  --sysroot=D:/ndk15/android-ndk-r15c/platforms/android-18/arch-arm -isysroot D:/ndk15/android-ndk-r15c/platforms/android-18/arch-arm -march=armv7-a -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
